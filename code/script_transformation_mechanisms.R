...
# ============================================================
# 5. CRIAR TRANSFORMAÇÕES IHS
# ============================================================

dados_saneamento <- dados_saneamento |>
  mutate(
    
    ihs_tx_inter_feco_oral =
      asinh(tx_inter_feco_oral),
    
    ihs_tx_inter_contato_agua =
      asinh(tx_inter_contato_agua),
    
    ihs_tx_inter_higiene =
      asinh(tx_inter_higiene)
    
  )


# ============================================================
# 6. CRIAR PASTA APPENDIX B
# ============================================================

if (!dir.exists("appendix_b")) {
  dir.create(
    "appendix_b",
    recursive = TRUE
  )
...
# ============================================================
# 8. FUNÇÃO PARA SALVAR TABELA EM TXT
# ============================================================
...
salvar_tabela_txt <- function(
  ...
  texto <- paste0(
    ...
    "Amostras: Full sample + Only treated\n",
    "============================================================\n"
  )
...
outcomes_saude <- c(
  ...
  # Log
  "ln_tx_inter_feco_oral",
  "ln_tx_inter_contato_agua",
  "ln_tx_inter_higiente"
  
)


# ============================================================
# 11. SEGUNDO GRUPO DE OUTCOMES
# ============================================================
...
outcomes_residuos <- c(
  ...
  "Quant_caminhoes",
  "quant_trabalhadores",
  "quant_material_reci_recuperado"
  
)


# ============================================================
# 12. ESTIMAÇÃO - GRUPO 1
# ============================================================

resultados_saude <- purrr::map_dfr(
...
# ============================================================
# 13. ESTIMAÇÃO - GRUPO 2
# ============================================================

resultados_residuos <- purrr::map_dfr(
...
write.csv(
  ...
  file =
    "appendix_b/tabela_final_appendix_b.csv",
