...
if (!dir.exists("resultados_principais_sem_controle")) {
  dir.create(
    "resultados_principais_sem_controle",
    recursive = TRUE
  )
}
...
# ============================================================
# 6. FUNÇÃO PARA SALVAR TABELA EM TXT
# ============================================================

salvar_tabela_txt <- function(
    resultado,
    outcome,
    path = "resultados_principais_sem_controle/"
) {
